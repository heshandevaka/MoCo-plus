...
class AbsWeighting(nn.Module):
    ...
    def _compute_grad(self, losses, mode, rep_grad=False, retain_graph=False):
        '''
    ...
    def _get_grads(self, losses, mode='backward', retain_graph=False):
        ...
        if self.rep_grad:
            ...
            grads = self._compute_grad(losses, mode, retain_graph=retain_graph)
            return grads
